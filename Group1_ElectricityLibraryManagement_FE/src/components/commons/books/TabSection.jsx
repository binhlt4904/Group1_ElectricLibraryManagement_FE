...
const TabSection = ({ activeTab, setActiveTab, contents, reviews, book, renderStars, relatedBooks, newReview, setNewReview,
  ...
  handleEditReview, handleDeleteReview, handleSaveEdit, canReadContents, lockMsg, showLockOverlay
}) => {
                      ...
                      <div key={content.id} className={styles.chapterItem}>
                        ...
                        >
                          <div className={styles.chapterInfo}>
                            <div className={styles.chapterNumber}>Chapter {content.chapter}</div>
                            <div className={styles.chapterTitle}>{content.title}</div>
                          </div>
                        </div>
                      </div>
                    ))}
